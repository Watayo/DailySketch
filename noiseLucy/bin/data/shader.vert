...
void main() {
  ...
  lightDirection = position.xyz - vec3(0);
  vertex = gl_Vertex.xyz;

  //Get original position of the gl_Vertex
  vec3 v = gl_Vertex.xyz;

  //Compute value of the distortion for current vertex
  float distort = distortAmount * specArray[3];
  distort *= cnoise(v) * 300 ;
...
//Noise https://github.com/ashima/webgl-noise/tree/master/src/classicnoise3D.glal
vec3 mod289(vec3 x)
{
