...
void ofApp::setup(){
    ...
    gui.add(separationDistance.set("separationDistance", 0, 0, 50));
    gui.add(alignmentDistance.set("alignmentDistance", 0, 0, 50));
    gui.add(cohesionDistance.set("cohesionDistance", 0, 0, 50));
...
void ofApp::update(){
    ...
    updatePos.setUniform1f("separationDistance", separationDistance / 500.0f);
    updatePos.setUniform1f("alignmentDistance", alignmentDistance / 500.0f);
    updatePos.setUniform1f("cohesionDistance", cohesionDistance / 500.0f);
